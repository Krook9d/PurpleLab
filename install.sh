...
echo -e "\n\e[32mAll checks passed. Continuing with the installation...\e[0m\n"
    ...
    curl -L -o sandbox.ova -H "User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3" "https://dl-9hk2c0sc.swisstransfer.com/api/download/e0926dc5-4b1c-4e30-96a1-2ef9fdc3ac8d/1d4e4660-0328-406c-b4fc-68b596234ddc"
